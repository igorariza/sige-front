...
const header = [
  ...
  { title: 'Nombre', prop: 'name', sortable: true, filterable: true },
  { title: 'Sede', prop: 'company', sortable: true, filterable: true },
  { title: 'Email', prop: 'email', sortable: true, filterable: true },
  { title: 'Telefono', prop: 'phone', sortable: true, filterable: true },
  { title: 'Ver', prop: 'date', sortable: true, filterable: true },
];
                ...
                <div className="content">
                    ...
                    <div className="page-title">
                        <div className="float-left">
                            <h1 className="title">Institución Educativa</h1>
                        </div>
                    </div>
                    ...
                    <div className="col-12">
                        <section className="box ">
                            <header className="panel_header">
                                <h2 className="title float-left">Docentes</h2>
